...
class SwapContract {
    ...
    depositInitialPmine(pmineAmount) {
        ...
        blockchain.callWithAuth("token.iost", "transfer", JSON.stringify(["tpmine", tx.publisher, blockchain.contractName(), pmineAmount.toString(), "Admin intial deposit of unbought pmines. "]));
    ...
    buyToken(pmineAmount) {
        ...
        blockchain.callWithAuth("token.iost", "transfer", JSON.stringify(["tpmine", blockchain.contractName(), tx.publisher, pmineAmount.toString(), "Powermine contract sends pmines to user. "]));
    ...
    sellToken(pmineAmount) {
        ...
        blockchain.callWithAuth("token.iost", "transfer", JSON.stringify(["tpmine", tx.publisher, blockchain.contractName(), pmineAmount.toString(), "User sends pmine to Powermine contract. "]));

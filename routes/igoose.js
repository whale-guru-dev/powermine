...
router.get('/getiGoosePrice', function(req,res,next) {
    iGoose.getiGoosePrice()
        .then(result => res.send(result))
        .catch(e => res.send(e))
});

router.get('/getIOSTInContract', function(req,res,next) {
    iGoose.getIOSTInContract()
        .then(result => res.send(result))
        .catch(e => res.send(e))
});

...
exports.grab_iGoose_balance = () => {
    return new Promise((resolve, reject) => {
        require('request').post('http://api.iost.io/getContractStorage', { body: JSON.stringify({ id: "ContractBbjSHzs2CEwWECHcUwFJXiSJRr2jb8NhvANa1MJgWX97", key: "igooseAmountOnContract", by_longest_chain: true }) }, function (error, response, body) {
            if (!error && response.statusCode == 200) {
...
exports.grab_total_staked = () => {
    return new Promise((resolve, reject) => {
        require('request').post('http://api.iost.io/getContractStorage', { body: JSON.stringify({ id: "ContractBbjSHzs2CEwWECHcUwFJXiSJRr2jb8NhvANa1MJgWX97", key: "totalStaked", by_longest_chain: true }) }, function (error, response, body) {
            if (!error && response.statusCode == 200) {
...
exports.grab_iGoose_accounts = () => {
    return new Promise((resolve, reject) => {
        require('request').post('http://api.iost.io/getContractStorage', { body: JSON.stringify({ id: "ContractBbjSHzs2CEwWECHcUwFJXiSJRr2jb8NhvANa1MJgWX97", key: "userStakes", by_longest_chain: true }) }, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                return resolve(body);
            } else {
                return reject('Failed')
...
exports.getiGoosePrice = () => {
    return new Promise((resolve, reject) => {
        require('request').post('http://api.iost.io/getContractStorage',{body: JSON.stringify({id:"ContractBbjSHzs2CEwWECHcUwFJXiSJRr2jb8NhvANa1MJgWX97",key:"tokenPrice",by_longest_chain:true})}, function (error, response, body) {
            if (!error && response.statusCode == 200) {
                return resolve(body)
            } else {
                return reject('Failed')
...
exports.getIOSTInContract = () => {
    return new Promise((resolve, reject) => {
        try {
            require('request').get('http://api.iost.io/getTokenBalance/ContractBbjSHzs2CEwWECHcUwFJXiSJRr2jb8NhvANa1MJgWX97/iost/true', function (error, response, body) {
                if (!error && response.statusCode == 200) {
                    const objx = JSON.parse(body)
